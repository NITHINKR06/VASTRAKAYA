...
export default function KarState() {


  const fullVideoUrl = `https://www.youtube.com/watch?v=vcN0khsFvyg`;
  ...
  const text = "This State is known for its simple yet elegant clothing. The traditional dress for women is the Saree, which is draped around the body and worn with a blouse and petticoat. Men wear the Dhoti and Kurta, which is a long tunic worn over the Dhoti.";
      ...
      <div style={styles.container}>
        <div style={styles.content}>
          ...
          <div style={styles.textBlock}>
            <h2 style={{ color: 'blue', fontFamily: 'Tapestry,serif' }}>Karnataka ❤️</h2>
      ...
      <Divider></Divider>            
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ textAlign: 'center', maxWidth: '700px' }}>
            <div>
              <p style={{ fontFamily: 'Satisfy, cursive', fontSize: '28px' }}>Kannada, one of the classical languages of India, is the most widely spoken and official language of the state. Other minority languages spoken...</p>
            </div>
            <div className='Landiv' style={{ gap: '-20px' }}>
              <div className='landivsub' style={{ display: 'flex', height: '50px' }}>
                <p className='lantext'>Kannada</p>
                <p className='lantext'>ಎಲ್ಲರಿಗೂ ನಮಸ್ಕಾರ</p>
              </div>
              <div className='landivsub' style={{ display: 'flex', height: '50px' }}>
                <p className='lantext'>Tulu</p>
                <p className='lantext'>Tigalari Script</p>
              </div>
              {/* <div className='landivsub' style={{ display: 'flex', height: '50px' }}>
